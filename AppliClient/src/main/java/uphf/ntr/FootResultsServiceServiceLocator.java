...
package uphf.ntr;
public class FootResultsServiceServiceLocator extends org.apache.axis.client.Service implements uphf.ntr.FootResultsServiceService {
    ...
    public uphf.ntr.FootResultsService getFootResultsService() throws javax.xml.rpc.ServiceException {
    ...
    public uphf.ntr.FootResultsService getFootResultsService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uphf.ntr.FootResultsServiceSoapBindingStub _stub = new uphf.ntr.FootResultsServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uphf.ntr.FootResultsService.class.isAssignableFrom(serviceEndpointInterface)) {
                uphf.ntr.FootResultsServiceSoapBindingStub _stub = new uphf.ntr.FootResultsServiceSoapBindingStub(new java.net.URL(FootResultsService_address), this);
                _stub.setPortName(getFootResultsServiceWSDDServiceName());
                return _stub;
            }
        }
