...
public class FootResultsServiceProxy implements uphf.ntr.FootResultsService {
  private String _endpoint = null;
  private uphf.ntr.FootResultsService footResultsService = null;
  ...
  private void _initFootResultsServiceProxy() {
    try {
      footResultsService = (new uphf.ntr.FootResultsServiceServiceLocator()).getFootResultsService();
  ...
  public uphf.ntr.FootResultsService getFootResultsService() {
    if (footResultsService == null)
      _initFootResultsServiceProxy();
